(() => {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const closeBtn = document.querySelector(".up-block__close-panel");
        const upblock = document.querySelector(".up-block");
        if (closeBtn && upblock) closeBtn.addEventListener("click", (function() {
